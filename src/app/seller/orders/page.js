  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      <header className="bg-teal-950 text-white py-3 sm:py-4 px-4 sm:px-6 flex justify-between items-center shadow-md">
        <Link
          href="/seller"
          className="text-teal-200 hover:text-white flex items-center space-x-1 text-xs sm:text-sm bg-teal-900 px-2.5 sm:px-3 py-1.5 rounded-lg transition-colors cursor-pointer"
        >
          <ArrowLeft className="w-4 h-4" />
          <span className="hidden sm:inline">Back to Catalog</span>
          <span className="sm:hidden">Back</span>
        </Link>
        <h1 className="text-sm sm:text-lg font-bold tracking-wide">Quotation History</h1>
            ...
            {orders.map((order) => (
              ...
              >
                <div className="bg-gray-50/70 px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200/80 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-3">
                  <div>
                    <span className="text-[10px] sm:text-xs text-gray-400 font-mono block break-all">
                ...
                <div className="bg-gray-50/50 px-4 sm:px-6 py-3 sm:py-4 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-3">

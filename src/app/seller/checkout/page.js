    ...
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center font-sans p-6">
        <div className="max-w-md w-full bg-white rounded-2xl p-8 border border-gray-100 shadow-xl text-center space-y-4">
          ...
          <h2 className="text-2xl font-bold text-teal-950">Quotation Submitted!</h2>
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      <header className="bg-teal-950 text-white py-4 px-6 flex justify-between items-center shadow-md">
        <div className="flex items-center space-x-3">
          <Link href="/seller" className="text-teal-200 hover:text-white flex items-center space-x-1 text-sm bg-teal-900 px-3 py-1.5 rounded-lg transition-colors cursor-pointer">
            <ArrowLeft className="w-4 h-4" />
            <span>Back to Catalog</span>
          </Link>
        </div>
        <h1 className="text-lg font-bold tracking-wide">Review & Checkout</h1>
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                {loading ? "Submitting Quotation..." : "Confirm & Submit Quotation"}
              </button>
            </form>
          </div>
        </div>

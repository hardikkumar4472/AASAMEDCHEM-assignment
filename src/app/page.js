    ...
    <div className="min-h-screen bg-white font-sans text-slate-800 flex flex-col justify-between">
      <header className="bg-white border-b border-slate-100 py-4 px-6 md:px-12 flex justify-between items-center sticky top-0 z-50">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-wide text-teal-950">AasaMedChem</h1>
            <p className="text-[10px] text-emerald-600 font-semibold tracking-wider uppercase">Solutions. Trust. Innovation.</p>
          </div>
        </div>
      ...
      <main className="flex-1 flex flex-col">
        <section className="relative overflow-hidden bg-gradient-to-br from-teal-50/30 via-white to-emerald-50/20 py-16 md:py-24 px-6 md:px-12 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-8 z-10">
            <div className="inline-flex items-center space-x-2 bg-emerald-50/80 border border-emerald-100 px-3.5 py-1.5 rounded-full">
              <CheckCircle className="w-4 h-4 text-emerald-600" />
              <span className="text-xs font-bold text-emerald-800 tracking-wide">Trusted by Pharma. Driven by Innovation.</span>
            </div>

            <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-teal-950 tracking-tight leading-[1.1] max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <Link
                href="/auth/login"
                className="bg-teal-850 bg-teal-800 hover:bg-teal-900 text-white font-bold px-7 py-3.5 rounded-xl transition-all flex items-center space-x-2 shadow-md cursor-pointer text-sm"
              >
                <UserCheck className="w-4 h-4" />
              ...
              <Link
                href="/auth/login"
                className="border border-emerald-600/40 text-emerald-700 hover:bg-emerald-50 font-bold px-7 py-3.5 rounded-xl transition-all flex items-center space-x-2 cursor-pointer text-sm"
              >
                <Shield className="w-4 h-4" />
          ...
          <div className="lg:col-span-5 relative flex items-center justify-center">
            ...
            <div className="relative w-full max-w-md aspect-square bg-slate-100 rounded-3xl overflow-hidden shadow-2xl border border-slate-200/50">
              <img
                src="/hero.png"
              ...
              <div className="absolute bottom-6 right-6 left-6 bg-white/90 backdrop-blur-md rounded-2xl p-5 border border-white/60 shadow-lg max-w-sm ml-auto">
        ...
        <section id="features" className="bg-slate-50/50 border-t border-slate-100 py-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              {[
                ...
                return (
                  <div
                    key={idx}
                    className={`bg-white p-6 rounded-3xl border border-slate-100/80 shadow-sm flex flex-col justify-between hover:shadow-xl hover:shadow-teal-950/5 hover:-translate-y-1.5 hover:border-emerald-500/20 transition-all duration-300 relative group overflow-hidden animate-slide-up ${feat.delay}`}
                  >
                    ...
                    <div>
                      <div className="p-3 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 text-emerald-700 rounded-2xl w-fit mb-5 border border-emerald-500/20 group-hover:from-emerald-500 group-hover:to-teal-800 group-hover:text-white transition-all duration-300 shadow-sm">
      ...
      <footer className="bg-teal-950 text-white pt-16 pb-8 border-t border-teal-900/50">
        <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex flex-col space-y-2.5 text-xs text-teal-300">
          ...
          <div>
            <h4 className="font-bold text-white text-sm mb-4">How it Works</h4>
            <div className="flex flex-col space-y-2.5 text-xs text-teal-300">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 border-t border-teal-900/60 pt-6 text-center flex flex-col sm:flex-row justify-between items-center text-xs text-teal-400 gap-3">
